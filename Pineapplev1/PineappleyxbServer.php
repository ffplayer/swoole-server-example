...
define('TSWOOLE_SERVERROOT', SERVER_ROOT . '/../');
define('TSWOOLE_LIBROOT', TSWOOLE_SERVERROOT . '../Lib/');
define('TSWOOLE_GAMETYPE', 'yxb');
include TSWOOLE_LIBROOT . 'SwooleService.php';
...
error_reporting(TSWOOLE_ENV?0:(E_WARNING|E_ERROR));
...
set_error_handler( 'error_handler', E_WARNING|E_ERROR); //注册错误函数
...
$crontab_work_table = new swoole_table(64);

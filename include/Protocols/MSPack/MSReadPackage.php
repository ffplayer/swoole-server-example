<?php
include_once __DIR__ . '/MSSocketPackage.php';
/**
...
class MSReadPackage extends MSSocketPackage {
	...
	public function ReadPackageBuffer($packet_buff){
		...
		$headerInfo = unpack("c2Iden/sCmdType/cVer/cSubVer/sLen/cCode", $this->m_packetBuffer->read(0, self::PACKET_HEADER_SIZE));
		...
		if ($this->m_packetSize) {
			...
			$DecryptObj = new MSEncryptDecrypt();
